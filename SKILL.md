...
#### 方法B：业务背景四段式（推荐用于配置类功能）

**业务场景**：用户在什么场景下使用这个功能？描述具体的业务流程和使用情境。

**行业特点**：本行业/本企业有什么特殊之处？涉及哪些专业领域或特殊要求？

**当前痛点**：现在存在什么问题？没有这个功能时用户怎么做的？有什么困难？

**解决方向**：本功能如何解决这些问题？预期达到什么效果？

> **示例**：
> - 业务场景：出于业务需要，用户会将最终产品的销售、物流、生产、采购等多流程文件上传到系统中进行线上管理...
> - 行业特点：硅材供应链主要包含组件、电池、硅片、硅棒、多晶硅、硅粉、工业硅、硅矿八大工段...
> - 当前痛点：不同场景对应的文件及数据串联关系均有不同，甚至同样工段根据代工客户不同也可能产生区别...
> - 解决方向：需要功能支持按不同供应链场景灵活配置链路...
...
| 模板 | 适用场景 | 章节数 |
|------|----------|--------|
| **11章完整结构** | 大型追溯项目，需覆盖全生命周期 | 11章 |
| **赛意7章结构** | 配置类功能（文件/权限/链路配置） | 7章 |
...
| 2. 目录 | 自动生成 |
| 3. 前言 | 说明、参与人员、参考文档 |
| 4. 概述 | 业务背景（四段式）、开发目的、使用说明 |
| 5. 总体设计 | 功能说明、功能列表、依赖示意图 |
| 6. 详细设计 | 界面设计、数据项设计（表格）、交互说明、补充逻辑 |
| 7. 未解决问题/已解决问题 | 问题跟踪 |
...
├── CHANGELOG.md                # 更新日志
├── reference/
│   ├── document-structure.md   # 完整章节结构（含11章+赛意7章）
│   ├── templates.md            # 各类模板集合
│   ├── tools.md                # 实用工具集
